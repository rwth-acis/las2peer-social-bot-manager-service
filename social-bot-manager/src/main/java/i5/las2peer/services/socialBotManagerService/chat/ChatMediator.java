...
public abstract class ChatMediator {
	...
	public void sendMessageToChannel(String channel, String text ) {
		sendMessageToChannel(channel, text, null);
	}
	/**
	 * Sends a chat message to a channel.
	 *
	 ...
	 *                replies to it later on.
	 */
	public void sendMessageToChannel(String channel, String text, HashMap<String, IncomingMessage> hashMap) {
		sendMessageToChannel(channel, text, hashMap,null);
	}
