...
java -ea -cp %CLASSPATH% i5.las2peer.tools.L2pNodeLauncher --port 9011 --service-directory service uploadStartupDirectory startService('i5.las2peer.services.socialBotManagerService.SocialBotManagerService@1.0.19') startWebConnector interactive
